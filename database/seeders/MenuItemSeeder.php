...
class MenuItemSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['menu_key' => 'gift_cards', 'title' => 'Gift Cards', 'category' => 'give', 'route_name' => 'gift-cards.my-cards', 'icon' => 'Gift', 'active_path_prefix' => '/gift-cards/my-cards', 'default_enabled' => true, 'bottom_nav_eligible' => true, 'requires_auth' => true, 'interest_tags' => ['gift_cards', 'shopping_deals'], 'sort_order' => 12],
            ...
            ['menu_key' => 'social_feed', 'title' => 'Social Feed', 'category' => 'community', 'route_name' => 'social-feed.index', 'icon' => 'Users', 'active_path_prefix' => '/social-feed', 'default_enabled' => false, 'requires_auth' => true, 'bottom_nav_eligible' => true, 'interest_tags' => ['community_events'], 'sort_order' => 24],
