...
return new class extends Migration
{
    ...
    {
        $columns = ['shipping_name', 'shipping_line1', 'shipping_line2', 'shipping_city', 'shipping_state', 'shipping_postal_code', 'shipping_country'];
        Schema::table('merchant_hub_offer_redemptions', function (Blueprint $table) use ($columns) {
            $toDrop = array_filter($columns, fn ($col) => Schema::hasColumn('merchant_hub_offer_redemptions', $col));
            if (! empty($toDrop)) {
