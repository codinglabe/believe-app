...
class Form1023Approved extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Congratulations! Your Form 1023 Application Has Been Approved',
        );
    }
