        ...
        try {
            ...
            if ($offering->asset) {
                ...
                if ($isLivestockAsset) {
                    ...
                    $getOrCreateListing = function ($tagNumber, $countryCode, $fractionalAssetId) use ($user) {
            ...
            $totalAmountInCents = StripeCustomerChargeAmount::chargeCentsFromNetUsd((float) $amountInvested, 'card');
