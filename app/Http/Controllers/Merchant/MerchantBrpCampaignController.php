...
class MerchantBrpCampaignController extends Controller
{
    ...
    public function startCheckout(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'award_triggers.*' => 'string|in:offer_engagement,purchase,visit,referral,promo_push',
            'trigger_rules' => 'required|array|min:1',
            'trigger_rules.*.trigger' => 'required|string|in:offer_engagement,purchase,visit,referral,promo_push',
