...
return new class extends Migration
{
    ...
    {
        Schema::create('associated_persons', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('kyc_link')->nullable(); // KYC link from Bridge
            $table->text('iframe_kyc_link')->nullable(); // Iframe URL for KYC
    ...
    {
        Schema::dropIfExists('associated_persons');
    }
};
