...
class Form1023Declined extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Form 1023 Application Status Update - Action Required',
        );
    }
