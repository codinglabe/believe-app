...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: "Form 1023 Applications", href: "#" },
]

export default function AdminForm1023Index({ applications, filters }: PageProps) {
  ...
  const handleFilterChange = (value: string) => {
    ...
    router.get(route("admin.form1023.index"), params, { preserveState: true })
  }
  ...
  const handleSearchChange = (value: string) => {
    ...
    searchTimeoutRef.current = setTimeout(() => {
      ...
      router.get(route("admin.form1023.index"), params, { preserveState: true, replace: true })
    }, 500)
  }
  ...
  const handleAction = (applicationId: number, status: "approved" | "needs_more_info" | "declined") => {
    ...
    router.patch(route("admin.form1023.update", applicationId), { status, message }, { preserveScroll: true })
  }
  ...
  const handleDeleteConfirm = () => {
    ...
    setIsDeleting(true)
    router.delete(route("admin.form1023.destroy", applicationToDelete), {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Form 1023 Applications" />
      <div className="m-2 md:m-4 space-y-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl font-semibold">Form 1023 Applications</h1>
            <p className="text-sm text-muted-foreground">Review and process Form 1023 exemption applications.</p>
          </div>
        </div>
        <Card>
          <CardHeader>
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-end">
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative">
                  ...
                  <Input
                    type="text"
                    placeholder="Search by application number, organization, or EIN..."
                    value={searchQuery}
              ...
              <div className="flex flex-col items-center justify-center py-16 px-4">
                ...
                <p className="text-sm text-muted-foreground text-center max-w-md">
                  {filters.search || (filters.status && filters.status !== "all")
                    ? "No Form 1023 applications match your search criteria. Try adjusting your filters or search terms."
                    : "There are no Form 1023 applications to display at this time."}
                </p>
              </div>
            ) : (
              <>
                        ...
                        <CardContent className="pt-3 space-y-3 px-3 pb-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground pl-6">
                              <span className="font-mono">{application.organization.ein}</span>
                              ...
                              <>
                                ...
                                <div className="flex gap-2">
                                  ...
                                  <Button 
                                    ...
                                    asChild
                                  >
                                    <Link href={route("admin.form1023.show", application.id)} className="flex items-center justify-center gap-1.5">
