...
import { FileText, ArrowLeft, Upload, X, Tag, Image as ImageIcon, BookOpen, Heart, Sparkles, CheckCircle2 } from 'lucide-react';
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                            <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
                                ...
                                >
                                    ...
                                    <h1 className="text-2xl sm:text-3xl font-bold leading-tight mb-2">Create Content</h1>
                                    <p className="text-muted-foreground text-sm sm:text-base">
                                        Add new prayer or devotional content
                                    </p>
                                </div>
                            </div>
                        </div>
