...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(135deg, #0f766e, #2563eb); padding: 28px; border-radius: 8px 8px 0 0; text-align: center;">
        <h1 style="color: #fff; margin: 0; font-size: 22px;">Invitation cancelled</h1>
    </div>
    <div style="background-color: #f8f9fa; padding: 28px; border-radius: 0 0 8px 8px;">
        <p style="font-size: 16px;">
            You cancelled the Believe Points gift invitation to
            <strong>{{ $recipientEmail }}</strong>.
        </p>
        <p style="font-size: 15px; color: #555;">
            <strong>{{ $amountLabel }} BP</strong> has been returned to your Available balance immediately.
            The recipient can no longer claim this gift.
        </p>
