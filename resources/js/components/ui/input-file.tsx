...
function InputFile({ className, ...props }: React.ComponentProps<"input">) {
    return (
      <input
        type="file"
        className={cn(
          "block w-full cursor-pointer sm:border border-input bg-transparent px-1 py-1 text-sm text-muted-foreground file:mr-4 file:rounded-md file:border-0 file:px-4 file:py-2 file:text-sm file:font-medium file:text-blue-700 hover:file:bg-blue-100",
