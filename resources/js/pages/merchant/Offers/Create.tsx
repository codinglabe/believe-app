        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0 space-y-2">
              <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">Create offer</h1>
              <p className="text-sm text-white/60">
                Follow each step to publish an offer. You can go back anytime before submitting.
              </p>
              <p className="truncate text-xs text-white/45">
                Offers <span className="mx-1.5">/</span> Create <span className="mx-1.5">/</span> {typeTitle}
              </p>
            </div>
            <div className="flex shrink-0 flex-wrap items-center gap-2">
              ...
              {step === TOTAL_STEPS ? (
                ...
                >
                  {processing ? "Publishing…" : "Publish offer"}
                </MerchantButton>
              ) : null}
            </div>
          </div>
          ...
          <div className="space-y-3 rounded-2xl border border-[#2563EB]/20 bg-black/20 p-4 backdrop-blur sm:p-5">
            ...
            <nav aria-label="Create offer steps" className="hidden gap-1.5 sm:flex sm:flex-wrap">
              {stepsMeta.map((meta) => {
          ...
          <form id="offer-create-form" onSubmit={handleSubmit} className="space-y-6">
            {stepError && (
              <div
                role="alert"
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(260px,320px)]">
                    ...
                    <MerchantCard className="gap-4 py-5">
                      <MerchantCardHeader>
                        ...
                        <MerchantCardDescription className="text-white/65">
                          Pick what matches your promotion. You can change this later only by creating a new offer.
                        </MerchantCardDescription>
                      </MerchantCardHeader>
                      <MerchantCardContent>
                  ...
                  {step === 6 && (
                    <MerchantCard className="gap-4 py-5 lg:hidden">
                      <MerchantCardHeader>
                        ...
                        <MerchantCardDescription className="text-white/65">
                          Review the summary below, then publish your offer.
                        </MerchantCardDescription>
                      </MerchantCardHeader>
                    </MerchantCard>
                  )}
              ...
              {/* Summary sidebar — desktop: steps 1–5 + review; mobile: review step only */}
              ...
              <>
                ...
                <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-[#2563EB]/20 bg-[#0a0f1a]/95 p-4 backdrop-blur-md sm:hidden">
                  <div className="mx-auto flex max-w-5xl flex-col gap-2">
                    <MerchantButton type="submit" form="offer-create-form" disabled={processing} className="w-full">
                      {processing ? "Publishing…" : "Publish offer"}
                    </MerchantButton>
                  </div>
                </div>
