            ...
            <MerchantCard className="shadow-2xl text-center">
              <MerchantCardContent className="p-8">
                ...
                <p className="text-gray-400 mb-4">
                  {submitted
                    ? `You earned ${campaign.reward_per_response_brp} BRP ($${campaign.reward_dollars}) for your feedback!`
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300">
                  ...
                  <span className="font-semibold">{campaign.reward_per_response_brp} BRP Earned</span>
                </div>
              </MerchantCardContent>
            </MerchantCard>
          </motion.div>
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
              <span className="flex items-center gap-1"><Gift className="h-3.5 w-3.5 text-emerald-400" /> Earn {campaign.reward_per_response_brp} BRP</span>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {processing ? 'Submitting...' : `Submit & Earn ${campaign.reward_per_response_brp} BRP`}
            </MerchantButton>
