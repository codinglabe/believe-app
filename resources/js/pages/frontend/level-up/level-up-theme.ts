...
export const levelUpApp = {
  cta: "bg-gradient-to-r from-purple-600 to-blue-600 font-semibold text-white shadow-md shadow-purple-500/20 transition hover:from-purple-500 hover:to-blue-500 dark:shadow-none",
  ctaLg:
    "bg-gradient-to-r from-purple-600 to-blue-600 py-7 text-base font-semibold text-white shadow-md shadow-purple-500/20 transition hover:from-purple-500 hover:to-blue-500 dark:shadow-none",
  titleGradient:
    "bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text font-bold text-transparent dark:drop-shadow-none",
  trackGradient:
  ...
  cardSurface:
    "border border-purple-200/90 bg-white/95 text-slate-900 shadow-md backdrop-blur-xl dark:border-purple-500/20 dark:bg-slate-950/50 dark:text-slate-100 dark:shadow-none",
  cardRingActive:
    "ring-1 ring-purple-400/50 ring-offset-2 ring-offset-white dark:ring-blue-500/35 dark:ring-offset-slate-950",
  panelSurface:
    "rounded-2xl border border-purple-200/90 bg-white/95 text-slate-900 shadow-lg backdrop-blur-xl dark:border-purple-500/20 dark:bg-slate-950/55 dark:text-slate-100 dark:shadow-none",
  ...
  scoreChip:
    "inline-flex items-center gap-1.5 rounded-full border border-purple-200 bg-gradient-to-r from-purple-50/95 to-blue-50/90 px-3 py-1.5 font-medium text-slate-800 shadow-sm dark:border-purple-500/30 dark:from-purple-500/12 dark:to-blue-600/12 dark:text-slate-100 dark:shadow-none",
  outlineButton:
