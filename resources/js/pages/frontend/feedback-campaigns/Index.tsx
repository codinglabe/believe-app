                      ...
                      <div className="mt-5 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-3">
                            ...
                            <p className="mt-1 text-2xl font-black text-emerald-300">{campaign.reward_per_response_brp} BP</p>
                            <p className="text-xs text-emerald-100/60">${campaign.reward_dollars.toFixed(2)} value</p>
                          </div>
