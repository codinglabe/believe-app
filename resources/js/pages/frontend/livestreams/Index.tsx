...
import { Video, Plus, Calendar, Play, Square, Eye, Trash2, Radio, ExternalLink, Cloud } from "lucide-react"
...
export default function SupporterLivestreamsIndex({ livestreams }: Props) {
          ...
          <div className="relative w-full px-4 py-10 sm:py-12 md:px-6 lg:px-8">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3 shrink-0">
                <Link href="/integrations/dropbox" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
            ...
            <Card className="border-border bg-card shadow-xl">
              <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="mb-8 max-w-sm text-muted-foreground">
                  Create your first meeting to host virtual events with VDO.Ninja.
                </p>
                <Link href="/livestreams/supporter/create">
                  <Button
                    size="lg"
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {livestream.status === "ended" ? (
                        ...
                        <div className="flex gap-2 pt-2">
                          <Link href={`/livestreams/supporter/${livestream.id}`} className="flex-1">
                            <Button
                              variant="outline"
                          ...
                          <Link href={`/livestreams/supporter/${livestream.id}/edit`}>
                            <Button
                              variant="outline"
                              size="sm"
          ...
          {livestreams.last_page > 1 && (
            <div className="mt-10 flex items-center justify-center gap-2">
              {Array.from({ length: livestreams.last_page }, (_, i) => i + 1).map((page) => (
                <Link
                  key={page}
                  href={`/livestreams/supporter?page=${page}`}
