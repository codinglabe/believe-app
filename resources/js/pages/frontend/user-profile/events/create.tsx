...
export default function CreateEvent() {
  const { auth, eventTypes } = usePage<PageProps>().props
  ...
  const goToNextTabSafely = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Defer tab switch to next tick so this click doesn't hit the new submit button
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!validateTab('basic') || !validateTab('location')) {
      toast.error('Please fill in all required fields before creating the event')
      return
    }
    ...
    router.post('/profile/events', submitData, {
      onSuccess: () => {
  ...
  return (
    <ProfileLayout title="Create Event" description="Create a new event for your community">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Share your event with the community</p>
            </div>
