                                                    ...
                                                    <Card className="group overflow-hidden border border-slate-200/70 bg-white text-slate-900 shadow-[0_16px_40px_rgba(15,23,42,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_60px_rgba(99,102,241,0.22)] dark:border-white/10 dark:bg-gradient-to-b dark:from-slate-950 dark:via-slate-950 dark:to-indigo-950/70 dark:text-white">
                                                        ...
                                                        <CardContent className="p-5 sm:p-6">
                                                            ...
                                                            <div className="flex items-center gap-1 mb-4">
                                                                ...
                                                                <span className="text-sm text-slate-600 dark:text-gray-400 ml-1 font-medium">
                                                            ...
                                                            {product.is_at_cost_pricing ? (
                                                                (() => {
                                                                    const at =
                                                                        Number(String(product.at_cost_display ?? "").replace(/[^0-9.]/g, "")) || 0
                                                                    const retail =
                                                                        Number(String(product.typical_retail_display ?? "").replace(/[^0-9.]/g, "")) || 0
