...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setErrors({});
        router.post(route('status-codes.store'), formData, {
            onError: (errors) => {
                setErrors(errors);
                showErrorToast('Failed to create status code');
                ...
                <Card className="px-0">
                    <CardHeader className="px-4 md:px-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight">Create Status Code</h1>
                                <p className="text-muted-foreground">
                                    Add a new status code to the system
                                </p>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={isSubmitting}>
                                    ...
                                    {isSubmitting ? 'Creating...' : 'Create Status Code'}
                                </Button>
                                <Link href={route('status-codes.index')}>
