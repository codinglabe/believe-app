...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: "Create",
        href: "/classification-codes/create",
    },
]
...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('classification-codes.store'), formData, {
            onError: (errors) => {
                setErrors(errors);
                showErrorToast('Failed to create classification code');
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Classification Code" />
                ...
                <Card className="px-0">
                    <CardHeader className="px-4 md:px-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight">Create Classification Code</h1>
                                <p className="text-muted-foreground">
                                    Add a new classification code to the system
                                </p>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={isSubmitting}>
                                    ...
                                    {isSubmitting ? 'Creating...' : 'Create Classification Code'}
                                </Button>
                                <Link href={route('classification-codes.index')}>
