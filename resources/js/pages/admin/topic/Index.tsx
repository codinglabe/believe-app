...
export default function TopicsIndex() {
    ...
    const handleSearch = debounce((value: string) => {
        router.get(route("topics.index"), { search: value }, { preserveState: true, replace: true })
    }, 300)
    ...
    const handleEditSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        if (selectedTopic) {
            put(route("topics.update", selectedTopic.id), {
                onSuccess: () => {
                    closeEditModal()
                },
                onError: (err) => {
    ...
    const handleDelete = () => {
        if (selectedTopic) {
            destroy(route("topics.destroy", selectedTopic.id), {
                onSuccess: () => {
                    closeDeleteModal()
                },
                onError: (err) => {
            ...
            <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
                <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    <DialogHeader>
                        ...
                        <DialogDescription>Enter the name for the new topic.</DialogDescription>
                    </DialogHeader>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    <DialogHeader>
                        ...
                        <DialogDescription>Edit the name of the topic.</DialogDescription>
                    </DialogHeader>
