...
interface MerchantHubOffer {
    id: number
    merchant_hub_merchant_id: number
...
export default function AdminOffersEdit({ offer, categories, merchants }: OffersEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        merchant_hub_merchant_id: offer.merchant_hub_merchant_id.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(`/admin/merchant-hub/offers/${offer.id}`, formData, {
            forceFormData: true,
            preserveScroll: true,
        })
    }
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1.5">
                            Update the details for the offer
                        </p>
                    </div>
