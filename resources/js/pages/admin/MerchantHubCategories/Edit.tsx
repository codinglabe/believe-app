...
interface MerchantHubCategoriesEditProps {
    category: MerchantHubCategory
}

export default function AdminMerchantHubCategoriesEdit({ category }: MerchantHubCategoriesEditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        put(`/admin/merchant-hub-categories/${category.id}`)
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Merchant Hub Category" />
