...
interface EditWalletPlanProps {
    plan: WalletPlan
}

export default function AdminWalletPlansEdit({ plan }: EditWalletPlanProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        put(route('admin.wallet-plans.update', plan.id))
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Wallet Plan" />
            
            <div className="space-y-6 p-4 sm:p-6">
                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Wallet Plan</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-1.5">
                            Update wallet subscription plan details
                        </p>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Stripe product and price IDs. These will be updated automatically if you change the price or frequency.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
